    ...
    class FallingRocks
    {
        ...
        static void Main()
        {
            ...
            while (true)
            {
                ...
                string rockFormPerCycle = rockForms[randomGenerator.Next(0, rockForms.Length - 1)];
                ...
                {
                    GameObject oldRockPossition = rocks[i];
                    GameObject newRockPossition = new GameObject();
